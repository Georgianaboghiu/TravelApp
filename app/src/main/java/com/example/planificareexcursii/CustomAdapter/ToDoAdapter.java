...
import com.example.planificareexcursii.activities.CheckListActivity;
import com.example.planificareexcursii.activities.MainActivity;
...
public class ToDoAdapter extends RecyclerView.Adapter<ToDoAdapter.MyViewHolder>{
    ...
    public ToDoAdapter(DataBaseHelper myDB , CheckListActivity activity){
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.mCheckBox.setChecked(toBoolean(item.getStattus()));
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            mCheckBox = itemView.findViewById(R.id.checkboxItem);
        }
    }
}
