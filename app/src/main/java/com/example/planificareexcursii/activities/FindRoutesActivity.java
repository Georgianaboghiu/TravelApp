...
public class FindRoutesActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // start = new LatLng(41.3949, 2.0086);
        // end = new LatLng(41.1258, 1.2035);
    ...
    private void getMyLocation() {
        ...
        mMap.setOnMyLocationChangeListener(new GoogleMap.OnMyLocationChangeListener() {
            ...
            public void onMyLocationChange(Location location) {
                ...
                LatLng ltlng=new LatLng(46.195992,21.287560);
...
//                mDestination = new LatLng(41.1258,1.2035);
                //  start=new LatLng(46.195992,21.287560);
    ...
    public void Findroutes(LatLng Start, LatLng End)
    {
        ...
        else
        {
            ...
            Routing routing = new Routing.Builder()
                    ...
                    .waypoints(Start, End)
                    .key("MYKEY")  //also define your api key here.
                    .build();
            routing.execute();
        }
    }
